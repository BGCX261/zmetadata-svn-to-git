...
def pingN(addr, times=1):
    ...
    try:
        ...
        try:
            ...
            # os module on windows doesn't have/need this
            pass
        ...
        if (seq_num == 0):
            ...
            average = total_time / seq_num
    except:
        # Something went wong, most probably a socket or connection error
        average = -1
        timeouts = times
...
if __name__=='__main__':
    ...
    average, timeouts = pingN(sys.argv[1], times)
    print "Aveage ping time to "+sys.argv[1]+" = "+str(average)+"ms"+" ("+str(timeouts)+" timed out)"
