...
getFeatureTemplate = '<ogc:Filter xmlns:ogc="http://ogc.org" xmlns:gml="http://www.opengis.net/gml"><ogc:BBOX><ogc:PropertyName>%s</ogc:PropertyName><gml:Box srsName="http://www.opengis.net/gml/srs/epsg.xml"><gml:coordinates>%s</gml:coordinates></gml:Box></ogc:BBOX></ogc:Filter>'
...
<Layer queryable="%s">
    ...
    <Style>
      ...
      <LegendURL width="20" height="10">
         ...
         <OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="http://10.50.130.45/cgi-bin/mapserv?map=/var/www/gis_data/sanfransisco_sauber.map&amp;version=1.1.1&amp;service=WMS&amp;request=GetLegendGraphic&amp;layer=blockgroups&amp;format=image/png"/>
      </LegendURL>    
    </Style>
</Layer>
'''
    ...
    <Request>
      <GetCapabilities>
        ...
        <DCPType>
          <HTTP>
            <Get>
              <OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="http://10.50.130.45:9080/geoserver/wms?"/>
            </Get>
            <Post>
              <OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="http://10.50.130.45:9080/geoserver/wms?"/>
            </Post>
  ...
  <Capability>
    <Request>
      <GetCapabilities>
        <DCPType>
          <HTTP>
            <Get onlineResource="http://10.50.130.45:9080/geoserver/wfs?"/>
          </HTTP>
        </DCPType>
        <DCPType>
          <HTTP>
            <Post onlineResource="http://10.50.130.45:9080/geoserver/wfs?"/>
          </HTTP>
        </DCPType>
      </GetCapabilities>
      <DescribeFeatureType>
...
##        <PropertyName>tmstamp</PropertyName>
##        <Literal>%s</Literal>
##</PropertyIsGreaterThan>


##
##select railstations.the_geom as rail_geom, provinces.the_geom
##from railstations, provinces
##where station_na = 'BOSKOP' and railstations.the_geom @ provinces.the_geom